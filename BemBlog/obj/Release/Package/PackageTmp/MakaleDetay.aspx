...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div class="Article">
        <h2><asp:Literal ID="ltrl_title" runat="server"></asp:Literal></h2> 
        <hr />
        <div>
            <label>Yazar : </label>&nbsp:&nbsp<asp:Literal ID="ltrl_author" runat="server"></asp:Literal>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            <label>Kategori : </label>&nbsp:&nbsp<asp:Literal ID="ltrl_category" runat="server"></asp:Literal>
        </div>
        <hr />
        <br />
        ...
        <div>
            ...
            <asp:ListView ID="lv_comments" runat="server">
                ...
                <ItemTemplate>
                    <label>Kullanıcı Adı : </label>&nbsp:&nbsp<%# Eval("KullaniciAdi") %>
                    <br />
                    <%# Eval("YorumIcerik") %>
                    <br />
                    <hr />
